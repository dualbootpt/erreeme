<?php
    ...
    $rightsidetextblock = loadtextblock($_GET['lang'],'empresa','RIGHTSIDETEXTBLOCK');
    ...
    if( $_GET['preview'] <> 'true' ) {
      $tpl->EDITMODELINK =  "<div class='editmode'><a>edit</a></div>" ;
        ...
        $tpl->EDITMODELINK =  "<div>".
                                    "<a class='editRightsidetextblock' pageid='empresa' value='edit'> edit |</a>".
                                    "<a class='editRightsidetextblock' pageid='empresa' value='save'> save |</a>".
                                    "<a class='editRightsidetextblock' pageid='empresa' value='cancel'> cancel </a>".
                              "</div>" ;
    }
